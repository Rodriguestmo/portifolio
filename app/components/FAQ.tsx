      ...
      <div className="mx-auto max-w-[1160px]">
        <AnimateIn variant="fadeUp">
          <h2 className="text-5xl leading-[1.05] tracking-tight md:text-6xl">
            <span className="heading-muted">{f.heading1}</span>
            <br />
            <span className="heading-bold">{f.heading2}</span>
          </h2>
        </AnimateIn>
            ...
            {f.items.map((faq, i) => (
              ...
              >
                ...
                >
                  ...
                  <span className="flex-1 font-medium text-black">{faq.question}</span>
                  <motion.span
          ...
          <div className="lg:sticky lg:top-24">
            <AnimateIn variant="slideRight" delay={0.2}>
              <div className="rounded-2xl border border-black/6 bg-white p-8">
                ...
                <p className="mt-5 text-2xl text-gray-300">{f.ctaTitle1}</p>
                <p className="text-2xl font-bold text-black">{f.ctaTitle2}</p>

                <p className="mt-4 text-sm leading-relaxed text-gray-500">{f.ctaDesc}</p>
