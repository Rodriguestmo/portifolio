...
const services: Service[] = [
  ...
  },
  {
    ...
    description:
      "Atendimento inteligente no WhatsApp que qualifica leads, agenda consultas e responde dúvidas 24/7. Seu time foca no que importa enquanto a IA faz o trabalho repetitivo.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
