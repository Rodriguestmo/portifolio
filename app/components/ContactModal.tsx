...
export default function ContactModal() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    const msg = encodeURIComponent(
      `Olá, vim pelo site! Meu nome é ${nome.trim()} e gostaria de conversar sobre um projeto.${email ? ` Meu e-mail é ${email}.` : ""}`
    );
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Header */}
        <div className="mb-6">
          <p className="text-xs font-medium uppercase tracking-widest text-gray-400">Fale comigo</p>
          <h2 className="mt-1 text-2xl font-bold text-black">Antes de ir pro WhatsApp</h2>
          <p className="mt-1 text-sm text-gray-500">
            Deixa seu nome e contato para eu já saber quem é você quando chegar a mensagem.
          </p>
        </div>
